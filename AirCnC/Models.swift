...
class User {
    ...
    // 미리 생성한 유저 정보
    static let sehyeon = User(name: "Sehyeon", image:"apple")
    static let jeongyeon = User(name: "Jeongyeon", image:"pome")
    static let donghyeon = User(name: "Donghyeon", image:"bish")
    static let sujin = User(name: "Sujin", image:"hus")
}
